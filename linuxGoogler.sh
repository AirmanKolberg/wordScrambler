...
time="$(time_remaining)"
	...
	firefox google.com/search?q=$word&oq=$word&aqs=firefox
	clear
...
time="$(time_remaining)"
	...
	firefox google.com/search?q=$word1+$word2&oq=$word1+$word2&aqs=firefox
	clear
...
time="$(time_remaining)"
	...
	firefox google.com/search?q=$word1+$word2+$word3&oq=$word1+$word2+$word3&aqs=firefox
	clear
...
time="$(time_remaining)"
	...
	firefox google.com/search?q=$word1+$word2+$word3+$word4&oq=$word1+$word2+$word3+$word4&aqs=firefox
	clear
